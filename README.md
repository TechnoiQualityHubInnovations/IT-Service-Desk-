...
![image](https://user-images.githubusercontent.com/48203727/236480308-79011ab5-b9ce-4882-8680-d6187df29865.png)
  ...
  •	After Submission of the ticket, the ticket will be assigned to Approver 
  
  •	Approver -Will Login from Privilege Account – Approver will click on Add comments -it will route to approver form.
  
  •	Once the Approver verifies with all the information provided, will Approve or Reject. Status of will Change as Approved / Rejected
  
  •	Approver adds the comments and clicks on Approve /Reject button. If approved – ticket will be assigned to Implementer. Status will be changed to Approved
